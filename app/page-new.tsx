      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`font-bold transition-all duration-300 ${
                scrollY > 50 ? 'text-lg text-blue-900' : 'text-xl text-white'
              }`}>
          ...
          <ul className="hidden md:flex items-center space-x-8">
            {['Home', 'About', 'Ministries', 'Sermons', 'Events', 'Give', 'Contact'].map((item) => (
              <li key={item}>
                <a 
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-tight">
              ...
              <span className="block text-blue-200 text-3xl md:text-4xl lg:text-5xl font-light mt-2">
                Ministries
              </span>
            </h1>
            
            {/* Subheading */}
            <p className="text-xl md:text-2xl lg:text-3xl text-blue-100 font-light max-w-4xl mx-auto leading-relaxed">
              Taking this generation back to God and making His voice heard in the nations
            </p>
            
            {/* Animated Quote */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto border border-white/20">
              <p className="text-lg md:text-xl text-yellow-200 italic font-medium">
                "Blessed to be a blessing"
              </p>
            </div>
